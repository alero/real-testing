...
public class Service {
    ...
    public void createData(String key, String value) {
        Insert insert = jdbcServiceProvider.get().createInsert("theTable");
    ...
    public void changeIt(String key, String value) {
        InsertOrUpdater insertOrUpdater = jdbcServiceProvider.get().createInsertOrUpdate("theTable");
    ...
    public String findIt(String key) {
        return jdbcServiceProvider.get().querySingle("select aValue from theTable where aName = ?", (resultSet, i) -> resultSet.getString("aValue"), key);
