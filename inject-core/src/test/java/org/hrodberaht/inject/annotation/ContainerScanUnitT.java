...
public class ContainerScanUnitT {
    ...
    public void testScanningOfImplementations() {
        ...
        register.scanPackageExclude("org.hrodberaht.inject.testservices.simple", AnyServiceDoNothingImpl.class);
    ...
    public void testDeepInterfaceLookupScanning() {
        ...
        registerJava.register(
                new RegistrationModuleAnnotationScanner() {
                    @Override
                    public void scan() {
                        scanAndRegister("org.hrodberaht.inject.testservices.sortedinterfaces");
                    }
                }
        );
        ...
        try {
            ...
            /*assertEquals(
                    "Found two Implementations " +
                            "\"class org.hrodberaht.inject.testservices.simple.AnyServiceDoSomethingImpl\"" +
                            ", \"class org.hrodberaht.inject.testservices.simple.AnyServiceDoNothingImpl\" " +
                            "matching the Interface \"interface org.hrodberaht.inject.testservices.simple.AnyService\"" +
    ...
    public void testScanningAndRegisterAScanningModule() {
        ...
        RegistrationModuleAnnotationScanner propertiesModule = new RegistrationModuleAnnotationScanner() {
            public void scan() {
                this.scanAndRegister("org.hrodberaht.inject.testservices.annotated_extra");
            }
        };
