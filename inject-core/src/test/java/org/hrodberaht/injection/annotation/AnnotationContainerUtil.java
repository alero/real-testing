...
import org.hrodberaht.injection.testservices.regmodules.RegisterModuleWithInstanceFactoryAnnotated;
...
public class AnnotationContainerUtil {
    ...
    public static InjectionRegisterModule prepareLargeVolvoRegister() {
        ...
        registerScan.scanPackage("org.hrodberaht.injection.testservices.largepackage");
        return registerJava;
    }
