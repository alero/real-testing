...
import org.hrodberaht.injection.PerformanceTests;
import org.hrodberaht.injection.testservices.annotated.Car;
import org.hrodberaht.injection.testservices.annotated.CarCreatorSingleton;
...
public class CloneContainerRegistrationUnitT implements PerformanceTests {
    ...
    public void testCopySingletonService() {
        ...
        registerJava.scanPackage("org.hrodberaht.injection.testservices.annotated");
