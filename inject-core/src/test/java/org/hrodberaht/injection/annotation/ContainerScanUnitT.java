...
import org.hrodberaht.injection.testservices.annotated_extra.Manufacturer;
import org.hrodberaht.injection.testservices.annotated_extra.SaabManufacturer;
import org.hrodberaht.injection.testservices.simple.AnyService;
import org.hrodberaht.injection.testservices.simple.AnyServiceDoNothingImpl;
...
import org.hrodberaht.injection.util.RegisterStub;
...
public class ContainerScanUnitT {
    ...
    public void testScanningOfImplementations() {
        ...
        register.scanPackageExclude("org.hrodberaht.injection.testservices.simple", AnyServiceDoNothingImpl.class);
    ...
    public void testDeepInterfaceLookupScanning() {
        ...
        registerJava.register(
                new RegistrationModuleAnnotationScanner() {
                    @Override
                    public void scan() {
                        scanAndRegister("org.hrodberaht.injection.testservices.sortedinterfaces");
                    }
                }
        );
    ...
    public void testScanningOfDuplicateImplementations() {
        ...
        InjectionRegisterScan register = new InjectionRegisterScan();
        // Tests scanning and exclusion of single class
        register.scanPackage("org.hrodberaht.injection.testservices.simple");
        ...
        try {
            ...
            /*assertEquals(
                    "Found two Implementations " +
                            "\"class org.hrodberaht.injection.testservices.simple.AnyServiceDoSomethingImpl\"" +
                            ", \"class org.hrodberaht.injection.testservices.simple.AnyServiceDoNothingImpl\" " +
                            "matching the Interface \"interface org.hrodberaht.injection.testservices.simple.AnyService\"" +
    ...
    public void testScanningAndRegisterAScanningModule() {
        ...
        RegistrationModuleAnnotationScanner propertiesModule = new RegistrationModuleAnnotationScanner() {
            public void scan() {
                this.scanAndRegister("org.hrodberaht.injection.testservices.annotated_extra");
            }
        };
