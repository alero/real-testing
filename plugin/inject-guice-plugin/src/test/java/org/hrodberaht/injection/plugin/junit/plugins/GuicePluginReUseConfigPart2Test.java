...
import org.hrodberaht.injection.plugin.junit.plugins.config.JUnitPluginConfig;
...
@ContainerContext(JUnitPluginConfig.class)
@RunWith(JUnit4Runner.class)
public class GuicePluginReUseConfigPart2Test {
    ...
    public void testForServiceWiring() throws Exception {
        ...
        assertEquals("something", injector.getInstance(InstanceInterface.class).doSomething());
    }
}