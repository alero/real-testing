...
package org.hrodberaht.injection.plugin.junit5.test.config;

import org.hrodberaht.injection.core.stream.InjectionRegistryBuilder;
import org.hrodberaht.injection.plugin.junit5.service.MyResource;
...
public class Course2ContainerConfigExample extends ContainerContextConfigBase {
    ...
    public void register(InjectionRegistryBuilder registryBuilder) {
        ...
        registryBuilder
                .scan(() -> "org.hrodberaht.injection.plugin.junit5.service")
                .resource(builder ->
                        builder
