...
package org.hrodberaht.injection.plugin.junit.datasource.test.config;
...
public class SQLLoadingContainerConfig extends ContainerContextConfigBase {
    ...
    public void register(InjectionRegistryBuilder registryBuilder) {
        ...
        dataSourcePlugin
                .loadSchema(dataSource, "org.hrodberaht.injection.plugin.course2")
        // .loadSchema(dataSource, "org.hrodberaht.injection.extensions.plugin.course2")
        ;


        registryBuilder
                .scan(() -> "org.hrodberaht.injection.plugin.junit.datasource.service")
                .resource(builder ->
                        builder
