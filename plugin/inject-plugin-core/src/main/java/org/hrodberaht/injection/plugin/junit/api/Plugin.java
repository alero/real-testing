...
public interface Plugin {
     ...
     * means that the plugin will be recreated each time its used by a unique testclass,
     * it also means the each test within a single test-class will reuse the seame plugin instance
     ...
     * means that the plugin will never be recreated duing a testsuite execution, to get this behaviour the runner is stored in a static cache.
     ...
     * @see ResourceLifeCycle#TEST_CLASS
     ...
     * @see ResourceLifeCycle#TEST_CONFIG
     ...
     * @see ResourceLifeCycle#TEST_SUITE
