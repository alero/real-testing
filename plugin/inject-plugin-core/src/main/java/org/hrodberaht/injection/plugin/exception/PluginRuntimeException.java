...
public class PluginRuntimeException extends RuntimeException {
    ...
    public PluginRuntimeException(String message, Throwable e) {
        super(message, e);
        this.args = null;
    }

    public PluginRuntimeException(Throwable e) {
        super(e);
        this.args = null;
    }
    ...
    public PluginRuntimeException(String message, Throwable e, Object... args) {
        super(message, e);
        this.args = args;
    }

    public PluginRuntimeException(Throwable e, Object... args) {
        super(e);
        this.args = args;
    }
