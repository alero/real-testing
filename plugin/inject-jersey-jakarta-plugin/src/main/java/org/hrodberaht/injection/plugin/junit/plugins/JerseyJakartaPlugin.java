...
import org.hrodberaht.injection.plugin.junit.jersey.jakarta.JerseyTestBuilder;
import org.hrodberaht.injection.plugin.junit.jersey.jakarta.JerseyTestRunner;
...
public class JerseyJakartaPlugin implements Plugin {

    private static final Logger LOG = LoggerFactory.getLogger(JerseyJakartaPlugin.class);
    ...
    public JerseyJakartaPlugin() {
    }

    public JerseyJakartaPlugin(LifeCycle lifeCycle) {
    ...
    private void readLoggingSettings() {
        try {
            InputStream inputStream = JerseyJakartaPlugin.class.getResourceAsStream("/logging.properties");
            if (inputStream != null) {
    ...
    public static class JerseyPluginBuilder {
        private final JerseyJakartaPlugin jerseyPlugin;

        protected JerseyPluginBuilder(JerseyJakartaPlugin jerseyPlugin) {
    ...
    static class TestContainerWrapper implements TestContainer {
        ...
        private final TestContainer innerContainer;
