...
public class JerseyClientRestassuredRequest {
    ...
    public JerseyClientRestassuredResponse patch(String path, MediaType mediaType, Object... values) {
        String pathValue = org.hrodberaht.injection.plugin.junit.jersey.jakarta.JerseyClientRestassured.replaceVariables(path, values);
        callHttpMethod(pathValue, mediaType, org.hrodberaht.injection.plugin.junit.jersey.jakarta.JerseyClientRestassured.HttpMethod.PATCH);
    ...
    public JerseyClientRestassuredResponse post(String path, MediaType mediaType, Object... values) {
        String pathValue = org.hrodberaht.injection.plugin.junit.jersey.jakarta.JerseyClientRestassured.replaceVariables(path, values);
        callHttpMethod(pathValue, mediaType, org.hrodberaht.injection.plugin.junit.jersey.jakarta.JerseyClientRestassured.HttpMethod.POST);
        return new JerseyClientRestassuredResponse(this);
    }
    ...
    public JerseyClientRestassuredResponse put(String path, MediaType mediaType, Object... values) {
        String pathValue = org.hrodberaht.injection.plugin.junit.jersey.jakarta.JerseyClientRestassured.replaceVariables(path, values);
        callHttpMethod(pathValue, mediaType, org.hrodberaht.injection.plugin.junit.jersey.jakarta.JerseyClientRestassured.HttpMethod.PUT);
        return new JerseyClientRestassuredResponse(this);
    }
    ...
    public JerseyClientRestassuredResponse get(String path, MediaType mediaType, Object... values) {
        String pathValue = org.hrodberaht.injection.plugin.junit.jersey.jakarta.JerseyClientRestassured.replaceVariables(path, values);
        callHttpMethod(pathValue, mediaType, org.hrodberaht.injection.plugin.junit.jersey.jakarta.JerseyClientRestassured.HttpMethod.GET);
        return new JerseyClientRestassuredResponse(this);
    }
    ...
    public JerseyClientRestassuredResponse delete(String path, MediaType mediaType, Object... values) {
        String pathValue = org.hrodberaht.injection.plugin.junit.jersey.jakarta.JerseyClientRestassured.replaceVariables(path, values);
        callHttpMethod(pathValue, mediaType, org.hrodberaht.injection.plugin.junit.jersey.jakarta.JerseyClientRestassured.HttpMethod.DELETE);
        return new JerseyClientRestassuredResponse(this);
    }
