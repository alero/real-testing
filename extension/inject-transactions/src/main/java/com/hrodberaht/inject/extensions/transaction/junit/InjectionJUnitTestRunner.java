...
public class InjectionJUnitTestRunner extends BlockJUnit4ClassRunner {
    ...
    private void verifyContainerTransactions(InjectContainer theContainer, com.hrodberaht.inject.extensions.transaction.junit.InjectionContainerCreator creator) {
        try {
